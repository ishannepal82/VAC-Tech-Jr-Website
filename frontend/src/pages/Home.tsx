...
export default function HomePage() {
  // Your state and hook logic remains unchanged
  ...
  useEffect(() => {
    ...
    fetchUserInfo();
  }, [tryuserfetch]); // Added dependency to useEffect for best practice
        ...
        <div className="flex flex-col md:flex-row items-center justify-between px-6 sm:px-10 md:px-16 lg:px-20 py-16 md:py-0 flex-grow">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-10 justify-center md:justify-start">
              ...
              <button className="border border-[#b3d9ff] text-[#b3d9ff] hover:bg-[#1a2f55] px-8 py-3 rounded-full font-semibold transition duration-300">
                Explore Projects
              </button>
            </div>
          </div>
